...
echo ('<h2 class="maplespace_wordpress_plugin-settings-page-section-header" >Google API key</h2>');
...
else echo '<h4 class="maplespace_wordpress_plugin-settings-page-section-subheader"> '. get_option('maplespace_wordpress_plugin_google_apikey') .' </h4>';
